  ...
  */
  ...
  class Settings {
    ...
    constructor() {
      ...
      _classPrivateFieldBase(this, _apiUrl)[_apiUrl] = typeof settings.apiUrl === 'string' && settings.apiUrl || process && process.env && process.env.WS_URL || ENDPOINT_DEFAULT.value;
