...
class Settings {
  ...
  constructor() {
    ...
    (0, _classPrivateFieldLooseBase2.default)(this, _emitter)[_emitter] = new _eventemitter.default(); // will become deprecated for supporting substrate connect light clients. apiType structure should be used instead

    (0, _classPrivateFieldLooseBase2.default)(this, _apiUrl)[_apiUrl] = typeof settings.apiUrl === 'string' && settings.apiUrl || process && process.env && process.env.WS_URL || _index.ENDPOINT_DEFAULT.value;
